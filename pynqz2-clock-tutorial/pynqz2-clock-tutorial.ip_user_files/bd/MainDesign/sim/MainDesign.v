...
module MainDesign
   (CLK_IN,
    ...
    LD2,
    LD3);
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLK_IN CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK_IN, CLK_DOMAIN MainDesign_CLK_IN, FREQ_HZ 125000000, INSERT_VIP 0, PHASE 0.000" *) input CLK_IN;
  output LD0;
  output LD1;
  output LD2;
  output LD3;
  ...
  assign LD0 = ClockDivider_0_CLK_OUT;
